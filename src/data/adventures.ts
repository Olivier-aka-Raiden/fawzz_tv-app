...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "2 300 km à travers la France et l'Italie. De Sochaux à la Côte d'Azur, détour par Sète, Béziers et Narbonne, passage par Monaco et la Riviera italienne (Savona, Gênes, La Spezia), ferry à Civitavecchia pour la Sicile (Trapani, Sciacca), puis Pozzallo → Malte.",
    badge: '2024 • SubaBike',
