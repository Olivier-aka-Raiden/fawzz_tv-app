...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "2 300 km à travers la France et l'Italie. De Sochaux à Marseille, détour par Sète et Béziers, passage par Pise et Rome, ferry à Civitavecchia pour la Sicile, puis Pozzallo → Malte.",
    badge: '2024 • SubaBike',
    dates: { start: '2024-09-06', end: '2024-10-10' },
    routeId: 'sochaux-malta-2024',
    highlights: [
      "Format SubaBike inédit : les subs allongent le parcours",
      "Détour Sète ↔ Béziers pour répondre à la communauté",
      "Deux traversées en ferry : Civitavecchia → Palerme, Pozzallo → Malte",
